...
// Configuration
const apikey = 'ptla_vueEhi1g2ZXHQD2362s0LrlCF7yIr0TqixeO3QrvH4o';
const capikey = 'ptlc_9aoSor6k7gtXCUo9OBvjkEkvsx3TyFO5Bbln1qCtMVx';
...
app.post('/api/login', (req, res) => {
  ...
  if (username === 'alluffy' && password === 'alluffy') {
