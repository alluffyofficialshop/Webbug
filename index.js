...
// Configuration
const apikey = 'ptla_KiLLj1Ko8V9n9WRWCWwppAc89CRO43HgSYAuXVCRNJx';
const capikey = 'ptlc_FqPFldmWqIcQMtSNZJedCsKlzZDxJllFqTRrfESE3ZI';
const domain = 'https://dimz.zakzzganteng.my.id';
const nestid = '5';
const egg = '15';
const loc = '1';
const gmailadmin = 'admin@gmail.com'; // Admin email that won't be deleted
const telegramBotToken = '8028504818:AAEPo_tqLmV42yfK7WIjofOJk4tKCucc-OY';
const adminTelegramId = '8186909381';
